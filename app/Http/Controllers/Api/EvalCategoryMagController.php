...
/**
 * 配送方式资源
 * @Resource("EvalCategoryMags",uri="/api")
 */
class EvalCategoryMagController extends Controller
{
     ...
     * })
     */
    public function show(EvalCategoryMag $mag)
    {
     ...
     * })
     */
    public function update(EvalCategoryMagRequest $request, EvalCategoryMag $mag)
    {
     ...
     * })
     */
    public function destroy(EvalCategoryMag $mag)
    {
