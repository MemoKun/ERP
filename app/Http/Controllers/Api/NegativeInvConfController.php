...
use App\Http\Requests\Api\NegativeInvConfRequest;
use App\Http\Requests\Api\EditStatuRequest;
use App\Http\Requests\Api\DestroyRequest;
use App\Transformers\NegativeInvConfTransformer;
use App\Http\Controllers\Traits\CURDTrait;

/**
 * 配送方式资源
 * @Resource("NegativeInvConfs",uri="/api")
 */
class NegativeInvConfController extends Controller
{
    use CURDTrait;

    const TRANSFORMER = NegativeInvConfTransformer::class;
    const MODEL = NegativeInvConf::class;
     ...
     * })
     */
    public function index(NegativeInvConfRequest $request)
    {
     ...
     * })
     */
    public function store(NegativeInvConfRequest $request)
    {
     ...
     * })
     */
    public function show(NegativeInvConf $conf)
    {
     ...
     * })
     */
    public function update(NegativeInvConfRequest $request, NegativeInvConf $conf)
    {
     ...
     * })
     */
    public function destroy(NegativeInvConf $conf)
    {
