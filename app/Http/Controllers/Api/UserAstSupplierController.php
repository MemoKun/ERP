...
/**
 * 配送方式资源
 * @Resource("UserAstSuppliers",uri="/api")
 */
class UserAstSupplierController extends Controller
{
     ...
     * })
     */
    public function show(UserAstSupplier $uas)
    {
     ...
     * })
     */
    public function update(UserAstSupplierRequest $request, UserAstSupplier $uas)
    {
     ...
     * })
     */
    public function destroy(UserAstSupplier $uas)
    {
