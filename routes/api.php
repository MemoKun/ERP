...
//            ->name('api.purchasereturns.isretrial');
        ...
        // 售后退款
        $api->get('aftersalerefund', 'AfterSaleRefundsController@index')
        ->name('api.aftersalerefund.index');
        $api->get('aftersalerefund/{aftersalerefund}', 'AfterSaleRefundsController@show')
            ->name('api.aftersalerefund.show');
        $api->post('aftersalerefund', 'AfterSaleRefundsController@store')
            ->name('api.aftersalerefund.store');
        $api->patch('aftersalerefund/{aftersalerefund}', 'AfterSaleRefundsController@update')
            ->name('api.aftersalerefund.update');
        $api->delete('aftersalerefund/{aftersalerefund}', 'AfterSaleRefundsController@destroy')
            ->name('api.aftersalerefund.destroy');
        $api->delete('aftersalerefund', 'AfterSaleRefundsController@destroybyids')
            ->name('api.aftersalerefund.destroybyids');
        $api->put('aftersalerefund/editstatus', 'AfterSaleRefundsController@editStatusByIds')
            ->name('api.aftersalerefund.editstatusbyids'); 
        // 售后退货
        $api->get('aftersalereturn', 'AfterSaleReturnsController@index')
        ->name('api.aftersalereturn.index');
        $api->get('aftersalereturn/{aftersalereturn}', 'AfterSaleReturnsController@show')
            ->name('api.aftersalereturn.show');
        $api->post('aftersalereturn', 'AfterSaleReturnsController@store')
            ->name('api.aftersalereturn.store');
        $api->patch('aftersalereturn/{aftersalereturn}', 'AfterSaleReturnsController@update')
            ->name('api.aftersalereturn.update');
        $api->delete('aftersalereturn/{aftersalereturn}', 'AfterSaleReturnsController@destroy')
            ->name('api.aftersalereturn.destroy');
        $api->delete('aftersalereturn', 'AfterSaleReturnsController@destroybyids')
            ->name('api.aftersalereturn.destroybyids');
        $api->put('aftersalereturn/editstatus', 'AfterSaleReturnsController@editStatusByIds')
            ->name('api.aftersalereturn.editstatusbyids'); 
        // 售后补件
        $api->get('aftersalepatch', 'AfterSalePatchsController@index')
        ->name('api.aftersalepatch.index');
        $api->get('aftersalepatch/{aftersalepatch}', 'AfterSalePatchsController@show')
            ->name('api.aftersalepatch.show');
        $api->post('aftersalepatch', 'AfterSalePatchsController@store')
            ->name('api.aftersalepatch.store');
        $api->patch('aftersalepatch/{aftersalepatch}', 'AfterSalePatchsController@update')
            ->name('api.aftersalepatch.update');
        $api->delete('aftersalepatch/{aftersalepatch}', 'AfterSalePatchsController@destroy')
            ->name('api.aftersalepatch.destroy');
        $api->delete('aftersalepatch', 'AfterSalePatchsController@destroybyids')
            ->name('api.aftersalepatch.destroybyids');
        $api->put('aftersalepatch/editstatus', 'AfterSalePatchsController@editStatusByIds')
            ->name('api.aftersalepatch.editstatusbyids'); 
        // 薛涛
