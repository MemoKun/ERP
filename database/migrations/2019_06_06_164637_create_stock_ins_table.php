...
class CreateStockInsTable extends Migration {
	...
	public function up()
	{
		Schema::create('stock_ins', function(Blueprint $table)
		{
			...
			$table->integer('submitter')->unsigned()->default(0)->comment('提交人');
			...
			$table->integer('auditor')->unsigned()->default(0)->comment('审核人');
			$table->dateTime('audit_at')->nullable()->comment('审核时间');
			$table->boolean('is_stock_in')->default(0)->comment('是否入库');
			$table->integer('warehouer')->unsigned()->default(0)->comment('入库人');
