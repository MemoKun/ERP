      ...
      <el-tab-pane label="订单列表" name="0">
        <div>
          ...
          <div class="searchBox" v-show="filterBox">
            ...
            <span>
              ...
              <el-select v-model="searchBox.order_company" clearable placeholder="请选择">
                <el-option v-for="item in searchBox.orderCompanys" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </span>
          </div>
          <div class="searchBox">
            <span>
              <label>发货时间</label>
              <el-date-picker v-model="searchBox.order_shipDate" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
              </el-date-picker>
            </span>
            <span>
              <label>支付时间</label>
              <el-date-picker v-model="searchBox.order_payDate" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
              </el-date-picker>
            </span>
            <span>
              <label>订单状态</label>
          ...
          <div class="searchBox">
            <span>
              <label>运费类型</label>
              <el-select v-model="searchBox.order_logisticFeeType" clearable placeholder="请选择">
                <el-option v-for="item in searchBox.orderLogisticFeeTypes" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </span>
            <span>
            ...
            <span>
              <label>物流单号</label>
              <el-input v-model="searchBox.order_LogisticNo" clearable></el-input>
            </span>
            <span>
              <label>外部单号</label>
          ...
          <div class="searchBox" >
            ...
            <span>
              <label>供应商</label>
              <el-select v-model="searchBox.order_supplier" clearable placeholder="请选择">
                <el-option v-for="item in searchBox.orderSuppliers" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </span>
            <span>
              ...
              <el-select v-model="searchBox.order_warehouse" clearable placeholder="请选择">
                <el-option v-for="item in searchBox.orderWarehouse" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </span>
            <span class="transMoney">
          ...
          <el-form :model="receiveInfo" class="half">
            <el-form-item v-for="(item,index) in addHead[addActiveName]" :key="index" :label="item.label" :prop="item.label">
              ...
              <span v-else-if="item.type=='cascader'">
                <el-cascader size="large" :options="options" v-model="receiveInfo[item.prop]">
                </el-cascader>
              </span>
              <span v-else>
