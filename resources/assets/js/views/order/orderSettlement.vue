            ...
            <el-tab-pane label="订单" name="0">
                <div>
                    <div class="searchBox">
                        ...
                        <span><label>物流公司</label>
                            <el-select v-model="searchBox.order_company" clearable clearable placeholder="请选择">
                                <el-option
                    ...
                    <div class="searchBox" v-show="filterBox">
                         <span>
                             <label>店铺名称</label><el-select v-model="searchBox.order_shop" clearable clearable
                                                           placeholder="请选择">
                                <el-option
                        ...
                        <span>
                                <label>结算日期</label>
                                 <el-date-picker
                                         v-model="searchBox.order_accountDate"
                                         type="daterange"
                                         range-separator="至"
                        ...
                        <span>
                                <label>发货时间</label>
                                 <el-date-picker
                                         v-model="searchBox.order_expressDate"
                                         type="daterange"
                                         range-separator="至"
                                         start-placeholder="开始日期"
                                         end-placeholder="结束日期">
