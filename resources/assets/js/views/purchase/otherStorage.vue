<template>
  <div>
    ...
    <el-tabs v-model="btmActiveName" @tab-click="clickBtmTabs">
      ...
      <el-tab-pane label="入库图片" name="storagePicture"></el-tab-pane>

      <el-tab-pane label="操作记录" name="storageRecord"></el-tab-pane>
    </el-tabs>

    <!-- 添加商品 -->
    <el-dialog title="添加商品" :visible.sync="newStorageDialog.show" :class="{'more-forms':moreForms}">
      <div class="searchBox cancelPur">
        ...
        <span>
          <label>开单时间</label>
          <el-date-picker v-model="newStorageDialog.data.start_at" type="date"></el-date-picker>
        </span>
      </div>
