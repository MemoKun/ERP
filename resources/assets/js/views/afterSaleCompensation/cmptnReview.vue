    ...
    data() {
      ...
      return {
        ...
        addCmptnOrderFormRules:{//新建订单的要求格式
          ...
          payee:[
            {required: true, message: '收款人必选', trigger:'blur'},
          ],
          payee_account:[
...
*/
    ...
    methods: {
      ...
      fetchData(){
        ...
        switch(index){
          case 0:
            this.$fetch(this.urls.aftercompensation+'/searchtreated',{include:'problemProduct.afterCompensationOrder,feeType'})
              .then(res => {
                this.loading = false;
            ...
            break;
          case 1:
            this.$fetch(this.urls.aftercompensation+'/searchsectreated',{include:'problemProduct.afterCompensationOrder,feeType'})
              .then(res => {
                this.loading = false;
