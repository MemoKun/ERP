<template>
  <div>
          ...
          <div class="searchBox">
            ...
            <span>
              ...
              <el-select v-model="searchBox.cmptn_direction" clearable placeholder="请选择">
                <el-option v-for="item in searchBox.cmptn_directions" :key="item.label" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </span>
            <span>
    ...
    <el-dialog title="驳回原因" :visible.sync="refuseMask">
      <el-input type="textarea" v-model="updateCmptnOrderFormVal.refuse_reason"></el-input>
