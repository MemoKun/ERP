      ...
      <el-tab-pane label="订单" name="0">
        ...
        <el-tabs v-model="leftTopActiveName" @tab-click="leftHandleClick" style="height: 400px;">
          <el-tab-pane label="所有订单" name="0">
            <el-table :data="cmptnOrderListTableData" fit @selection-change="handleSelectionChange" v-loading="loading" height="350" @row-click="problemProRowClick">
          ...
          <el-tab-pane label="未处理" name="1">
            <el-table :data="allUnHandle" fit @selection-change="handleSelectionChange" v-loading="loading" height="350" @row-click="problemProRowClick">
              <el-table-column type="selection" width="95" align="center" :checked="checkboxInit">
              </el-table-column>
              <el-table-column v-for="item in cmptnOrderListTableHead" :label="item.label" align="center" :width="item.width" :key="item.label">
                <template slot-scope="scope">
          ...
          <el-tab-pane label="已处理" name="2">
            <el-table :data="alreadyHandle" fit @selection-change="handleSelectionChange" v-loading="loading" height="350" @row-click="problemProRowClick">
              <el-table-column type="selection" width="95" align="center" :checked="checkboxInit">
              </el-table-column>
              <el-table-column v-for="item in cmptnOrderListTableHead" :label="item.label" align="center" :width="item.width" :key="item.label">
                <template slot-scope="scope">
          ...
          <el-tab-pane label="已作废" name="3">
            <el-table :data="alreadyCanceled" fit @selection-change="handleSelectionChange" v-loading="loading" height="350" @row-click="problemProRowClick">
              <el-table-column type="selection" width="95" align="center" :checked="checkboxInit">
              </el-table-column>
              <el-table-column v-for="item in cmptnOrderListTableHead" :label="item.label" align="center" :width="item.width" :key="item.label">
                <template slot-scope="scope">
...
*/
  ...
  methods: {
    ...
    handleSecAudit() {
      ...
      this.$put(this.urls.aftercompensation + "/" + id + "/secaudit").then(
        () => {
          this.refresh();
          this.$message({
            message: "审核成功",
    ...
    handleSecUnAudit() {
      let id = this.checkboxId ? this.checkboxId : this.curRowId;
      this.$put(this.urls.aftercompensation + "/" + id + "/secunaudit").then(
        () => {
          this.refresh();
          this.refuseMask = false;
          this.refuse_reason = "";
