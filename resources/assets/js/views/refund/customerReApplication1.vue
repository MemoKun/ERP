<template>
    <div>
        ...
        <Pagination :page-url="urls['customerReApplication']"></Pagination>
        ...
        <el-dialog title="新增退款单" :visible.sync="newRefundDialog.show"
                   :class="{'more-forms':moreForms}">
            <div class="search_box">
                <div class="searchBox cancelPur">
                    <span>
                        <label>退款单号</label>
                        <el-input placeholder="系统自动生成"
                                  disabled v-model="newRefundDialog.data.refund_no"></el-input>
                    </span>
                    <span>
                        <label>系统单号</label>
                        <el-input v-model="newRefundDialog.data.system_no"></el-input>
                    </span>
                    <span>
                        <label>退款方式</label>
                        <el-select v-model="newRefundDialog.data.refund_func" clearable placeholder="请选择"
...
<!--                    <el-option v-for="item in resData.shopNames" :key="item.value" :label="item.name" :value="item.id"></el-option>-->
                    ...
                    <span>
                        <label>建单时间</label>
                        <el-input disabled v-model="newRefundDialog.data.create_at"></el-input>
                    </span>
                </div>
                <div class="searchBox cancelPur">
                    <span>
                        <label>超时时间</label>
                        <el-date-picker v-model="newRefundDialog.data.timeout_at" type="date">
                        </el-date-picker>
                    </span>
                    <span>
                        <label>所属店铺</label>
                        <el-select v-model="newRefundDialog.data.shopName" clearable placeholder="请选择"
                                   @keyup.enter.native="handleQuery">
                    <el-option v-for="item in resData.shopNames" :key="item.value" :label="item.name"
                               :value="item.id"></el-option>
                        </el-select>
                    </span>
                    <span>
                        <label>还款账号</label>
                        <el-input v-model="newRefundDialog.data.refund_account"></el-input>
                    </span>
                    <span>
                        <label>还款类型</label>
                        <el-select v-model="newRefundDialog.data.refund_type" clearable placeholder="请选择"
                                   @keyup.enter.native="handleQuery">
<!--                    <el-option v-for="item in resData.shopNames" :key="item.value" :label="item.name" :value="item.id"></el-option>-->
                        </el-select>
                    </span>
                ...
                <div class="searchBox cancelPur">
                    <span>
                        <label>开户银行</label>
                        <el-input v-model="newRefundDialog.data.bank_name"></el-input>
                    </span>
                    <span>
                        <label>开户地址</label>
                        <el-input v-model="newRefundDialog.data.bank_address"></el-input>
                    </span>
                    <span>
                        <label>还款金额</label>
                        <el-input v-model="newRefundDialog.data.refund_amount"></el-input>
                    </span>
                    <span>
                        <label>交易单号</label>
                        <el-input v-model="newRefundDialog.data.trans_no"></el-input>
                    </span>
                </div>
                <div class="searchBox cancelPur">
                    <span>
                        <label>拍拍单号</label>
                        <el-input v-model="newRefundDialog.data.paipai_no"></el-input>
                    </span>
                    <span>
                        <label>退款原因</label>
                        <el-input v-model="newRefundDialog.data.refund_reason"></el-input>
                    </span>
                    <span>
                        <label>买家昵称</label>
                        <el-input v-model="newRefundDialog.data.buyer_nick"></el-input>
                    </span>
                    <span>
                        <label>买家姓名</label>
                        <el-input v-model="newRefundDialog.data.buyer_name"></el-input>
                    </span>
                </div>
                <div class="searchBox cancelPur">
                    <span>
                        <label>支付金额</label>
                        <el-input v-model="newRefundDialog.data.pay_amount"></el-input>
                    </span>
                    <span>
                        <label>拍单金额</label>
                        <el-input v-model="newRefundDialog.data.pai_amount"></el-input>
                    </span>
                    <span>
                        <label>拍单时间</label>
                        <el-input v-model="newRefundDialog.data.pai_at"></el-input>
                    </span>
                    <span>
                        <label>是否发货</label>
                        <el-checkbox v-model="newRefundDialog.data.is_ship"></el-checkbox>
                    </span>
                    <span>
                        <label>责任人</label>
                        <el-input v-model="newRefundDialog.data.principal"></el-input>
                    </span>
                </div>
                <div class="searchBox cancelPur">
                    <span>
                        <label>退款说明</label>
                        <el-input type="textarea" v-model="newRefundDialog.data.refund_mark"></el-input>
                    </span>
                    <span>
                        <label>业务备注</label>
                        <el-input type="textarea" v-model="newRefundDialog.data.business_mark"></el-input>
                    </span>
                </div>
            </div>

            <el-button type="text">退款原因</el-button>
            <el-table :data="newRefundDialog.data.data" fit height="350" :row-class-name="cancelRowCName"
                      @cell-click="addCellClick">
                <el-table-column v-for="(item,index) in newRefundDialog.data.tableHead" :label="item.label"
