    ...
    <div>
        <div class="search_box">
            ...
            <div class="searchBox">
                <span>
                    <label>售后时间</label>
                    <el-date-picker v-model="searchBox.sale_time" type="daterange" range-separator="至"
                                    start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                </span>
                <span>
                    <label>财审时间</label>
                    <el-date-picker v-model="searchBox.audit_time" type="daterange" range-separator="至"
                                    start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                </span>
            </div>
        ...
        <Pagination :page-url="urls['financialReAudit']"></Pagination>
        ...
        <el-tabs v-model="btmActiveName" @tab-click="clickBtmTabs">
            ...
            <el-tab-pane label="订单退款记录" name="refundRecord">
                <el-table :data="refundRecord.data" fit
                          v-loading="refundRecord.loading"
                          height="300">
                    <el-table-column
                            type="selection"
                            width="95" align="center"
                    ...
                    <el-table-column v-for="item in refundRecord.table" :label="item.label" align="center"
                                     :width="item.width"
                                     :key="item.prop">
                        <template slot-scope="scope">
                            <span v-if="item.type === 'select'">
