  ...
  <div>
    <el-tabs>
      <div class="searchBox">
        ...
        <span>
          <label>业务日期</label>
          <el-date-picker v-model="searchBox.work_date" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
          </el-date-picker>
        </span>
        <span>
          <label>买家昵称</label>
    ...
    <el-tabs>
      <el-tab-pane label="订单信息" name="0">
        <el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="订单交易号" width="120">
            <!--<template slot-scope="scope">{{ scope.row.date }}</template>-->
          </el-table-column>
          <el-table-column prop="" label="应付金额" width="120">
          </el-table-column>
          <el-table-column prop="" label="实付金额" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="" label="买家昵称" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="" label="创建时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="" label="订单状态" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="" label="分阶段状态" show-overflow-tooltip>
          </el-table-column>
        </el-table>
      </el-tab-pane>
    </el-tabs>
