  ...
  <div>
    ...
    <el-tabs v-model="activeName" @tab-click="handleTabsClick">
      <el-tab-pane label="未打印" name="0">
        <el-table :data="orderData" @selection-change="handleSelectionChange" v-loading="orderLoading" @row-click="orderRClick">
    ...
    <Pagination :page-url="this.urls.resupplieShip" @handlePagChg="handlePagChg"></Pagination>
    <!--补件信息tab-->
