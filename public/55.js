            ...
            [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("el-tab-pane", {
                    attrs: { label: "优惠列表", name: "6" }
                  }),
                  _vm._v(" "),
                  _c("el-tab-pane", {
                    attrs: { label: "订单图片", name: "7" }
                  }),
                  _vm._v(" "),
                  _c("el-tab-pane", { attrs: { label: "电子面单", name: "8" } })
                ],
                1
              )
            ],
