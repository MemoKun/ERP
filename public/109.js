...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2a24b4c3", Component.options)
  } else {
    hotAPI.reload("data-v-2a24b4c3", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return _ref = {
      newOpt: [{
        ...
        cnt: '驳回',
        icon: 'bf-reject',
        ent: this.refuseCmptn,
        ref: 'reject'
      }, {
        cnt: '审核',
        icon: 'bf-audit',
        ent: this.handleSecAudit
      }, {
        cnt: '退审',
        icon: 'bf-auditfaild',
      ...
      searchBox: {
        ...
        responsible_party: '',
        responsible_partys: [{ label: '物流', value: 0 }, { label: '工厂', value: 1 }, { label: '服务商', value: 2 }, { label: '客户', value: 3 }, { label: '公司', value: 4 }, { label: '其他', value: 5 }],
        responsible_person: '',
        logistics_company: '',
    ...
    }, _defineProperty(_ref, 'moreForms', true), _defineProperty(_ref, 'threeParts', true), _defineProperty(_ref, 'toggleText', false), _defineProperty(_ref, 'defectiveProductsListVal', []), _defineProperty(_ref, 'defectiveProductsHead', [{
      label: '商品编码',
      width: '200',
      prop: 'proCode',
      type: 'text'
      ...
      type: 'text',
      width: '120'
    }]), _defineProperty(_ref, 'defProData', {
      commodity_code: '',
      spec_code: '',
      short_name: '',
      spec: '',
      ...
      other: '',
      buy_number: ''
    }), _defineProperty(_ref, 'refuseMask', false), _defineProperty(_ref, 'refuse_reason', ''), _ref;
  },
  ...
  methods: {
    ...
    fetchData: function fetchData() {
      ...
      switch (index) {
        case 0:
          this.$fetch(this.urls.aftercompensation + '/searchtreated').then(function (res) {
            _this.loading = false;
    ...
    /*审核*/
    handleSecAudit: function handleSecAudit() {
      var _this16 = this;

      var id = this.checkboxId ? this.checkboxId : this.curRowId;
      this.$put(this.urls.aftercompensation + '/' + id + '/secaudit').then(function () {
        _this16.refresh();
        _this16.$message({
          message: '审核成功',
          type: 'success'
    ...
    refuseCmptn: function refuseCmptn() {
    ...
    refuseConfirm: function refuseConfirm() {
      ...
      this.$put(this.urls.aftercompensation + '/' + id + '/unaudit').then(function () {
        _this17.refresh();
        _this17.refuseMask = false;
        _this17.refuse_reason = '';
        _this17.$message({
          message: '退审成功',
          type: 'success'
        });
    ...
    handleSecUnAudit: function handleSecUnAudit() {
      var _this18 = this;

      var id = this.checkboxId ? this.checkboxId : this.curRowId;
      this.$put(this.urls.aftercompensation + '/' + id + '/secunaudit').then(function () {
        _this18.refresh();
        _this18.refuseMask = false;
        _this18.refuse_reason = '';
        _this18.$message({
          message: '退审成功',
          type: 'success'
        });
  ...
  return _c(
    ...
    [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("el-input", {
                        attrs: { clearable: "" },
                        model: {
                          value: _vm.searchBox.customer_nickname,
                          callback: function($$v) {
                            _vm.$set(_vm.searchBox, "customer_nickname", $$v)
                          },
                          expression: "searchBox.customer_nickname"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("el-input", {
                        attrs: { clearable: "" },
                        model: {
                          value: _vm.searchBox.customer_name,
                          callback: function($$v) {
                            _vm.$set(_vm.searchBox, "customer_name", $$v)
                          },
                          expression: "searchBox.customer_name"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("el-input", {
                        attrs: { clearable: "" },
                        model: {
                          value: _vm.searchBox.customer_phone,
                          callback: function($$v) {
                            _vm.$set(_vm.searchBox, "customer_phone", $$v)
                          },
                          expression: "searchBox.customer_phone"
                        }
                      })
                    ],
                    1
                    ...
                    ? _c(
                        ...
                        [
                          ...
                          _c("el-input", {
                            attrs: { clearable: "" },
                            model: {
                              value: _vm.searchBox.customer_address,
                              callback: function($$v) {
                                _vm.$set(_vm.searchBox, "customer_address", $$v)
                              },
                              expression: "searchBox.customer_address"
                            }
                          })
                        ],
                        1
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("el-input", {
                          attrs: { clearable: "" },
                          model: {
                            value: _vm.searchBox.order_stuff,
                            callback: function($$v) {
                              _vm.$set(_vm.searchBox, "order_stuff", $$v)
                            },
                            expression: "searchBox.order_stuff"
                          }
                        })
                      ],
                      1
                      ...
                      [
                        ...
                        _c(
                          "el-select",
                          {
                            attrs: { clearable: "", placeholder: "请选择" },
                            model: {
                              value: _vm.searchBox.responsible_party,
                              callback: function($$v) {
                                _vm.$set(
                                  _vm.searchBox,
                                  "responsible_party",
                              ...
                              expression: "searchBox.responsible_party"
                            }
                          },
                          _vm._l(_vm.searchBox.responsible_partys, function(
                            item
                          ) {
                            return _c("el-option", {
                              key: item.value,
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("el-input", {
                          attrs: { clearable: "" },
                          model: {
                            value: _vm.searchBox.responsible_person,
                            callback: function($$v) {
                              _vm.$set(_vm.searchBox, "responsible_person", $$v)
                            },
                            expression: "searchBox.responsible_person"
                          }
                        })
                      ],
                      1
                  ...
                  [
                      ...
                      [
                        ...
                        _c(
                          "el-select",
                          {
                            attrs: { clearable: "", placeholder: "请选择" },
                            model: {
                              value: _vm.searchBox.logistics_company,
                              callback: function($$v) {
                                _vm.$set(
                                  _vm.searchBox,
                                  "logistics_company",
                              ...
                              expression: "searchBox.logistics_company"
                            }
                          },
                          _vm._l(_vm.searchBox.logistics_companys, function(
                            item
                          ) {
                            return _c("el-option", {
                              key: item.value,
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("el-input", {
                          model: {
                            value: _vm.searchBox.logistics_tracking_number,
                            callback: function($$v) {
                              _vm.$set(
                                _vm.searchBox,
                                "logistics_tracking_number",
                            ...
                            expression: "searchBox.logistics_tracking_number"
                          }
                        })
                      ],
                      1
                      ...
                      [
                        ...
                        _c(
                          "el-select",
                          {
                            attrs: { clearable: "", placeholder: "请选择" },
                            model: {
                              value: _vm.searchBox.cmptn_shop,
                              callback: function($$v) {
                                _vm.$set(_vm.searchBox, "cmptn_shop", $$v)
                              },
                              expression: "searchBox.cmptn_shop"
                            }
                          },
                          _vm._l(_vm.searchBox.cmptn_shops, function(item) {
                            return _c("el-option", {
                              key: item.value,
                              attrs: { label: item.label, value: item.value }
                            })
      ...
      _c(
        ...
        [
          ...
          _c(
            "el-form",
            {
              staticClass: "cmptnAddForm hidePart",
              attrs: {
                model: _vm.addCmptnOrderFormVal,
                rules: _vm.addCmptnOrderFormRules,
                id: "form"
              }
            },
                          ...
                          ? _c(
                              ...
                              [
                                _c("el-input", {
                                  ...
                                  model: {
                                    value:
                                      _vm.addCmptnOrderFormVal[item.prop][
                                        item.inProp
                                      ],
                                    callback: function($$v) {
                                      _vm.$set(
                                    ...
                                    expression:
                                      "addCmptnOrderFormVal[item.prop][item.inProp]"
                                  }
                                })
                              ],
                              1
                          ...
                          _c(
                            "el-select",
                            {
                              ...
                              model: {
                                ...
                                expression: "addCmptnOrderFormVal[item.prop]"
                              }
                            },
        ...
        [
          ...
          _c(
            "el-form",
            {
              staticClass: "cmptnAddForm hidePart",
              attrs: {
                model: _vm.updateCmptnOrderFormVal,
                rules: _vm.addCmptnOrderFormRules,
                id: "form"
              }
            },
                          ...
                          ? _c(
                              ...
                              [
                                _c("el-input", {
                                  ...
                                  model: {
                                    value:
                                      _vm.updateCmptnOrderFormVal[item.prop][
                                        item.inProp
                                      ],
                                    callback: function($$v) {
                                      _vm.$set(
                                    ...
                                    expression:
                                      "updateCmptnOrderFormVal[item.prop][item.inProp]"
                                  }
                                })
                              ],
                              1
                              ...
                              [
                                _c("el-input", {
                                  ...
                                  model: {
                                    ...
                                    expression:
                                      "updateCmptnOrderFormVal[item.prop]"
                                  }
                                })
                              ],
                              1
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              model: {
                                value: _vm.updateCmptnOrderFormVal[item.prop],
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.updateCmptnOrderFormVal,
                                    item.prop,
                                ...
                                expression: "updateCmptnOrderFormVal[item.prop]"
                              }
                            },
                            _vm._l(_vm.addSubData[item.stateVal], function(
                              list
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      attrs: { type: "primary" },
                      on: { click: _vm.updateCmptnConfirm }
                    },
                    [_vm._v("确定")]
                  ),
                  _vm._v(" "),
      ...
      _c(
        "el-dialog",
        {
          attrs: { title: "驳回原因", visible: _vm.refuseMask },
          on: {
            "update:visible": function($event) {
              _vm.refuseMask = $event
            }
          }
        },
        [
          _c("el-input", {
            attrs: { type: "textarea" },
            model: {
              value: _vm.refuse_reason,
              callback: function($$v) {
                _vm.refuse_reason = $$v
              },
              expression: "refuse_reason"
            }
          }),
          _vm._v(" "),
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("el-button", { on: { click: _vm.refuseCancel } }, [
                _vm._v("取消")
              ])
            ],
            1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2a24b4c3", module.exports)
  }
}
