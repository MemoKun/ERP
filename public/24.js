...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    proQueryClick: function proQueryClick() {
      ...
      this.$fetch(this.urls.stocks, {
        status: true,
        include: "warehouse,product,productComponent"
      }).then(function (res) {
    ...
    updatePurReturn: function updatePurReturn() {
      ...
      if (this.newOpt[1].nClick) {
        ...
        this.$fetch(this.urls.purchasereturns + "/" + id, {
          include: "purchaseReturnDetails.stock.productComponent,purchaseReturnDetails.stock.product,purchaseReturnDetails.stock.warehouse,purchaseReturnDetails.supplier,purchaseReturnDetails.purchaseReturnType"
        }).then(function (res) {
    ...
    bfSubmit: function bfSubmit() {
      ...
      if (this.newOpt[3].nClick) {
        ...
        var id = this.checkboxId ? this.checkboxId : this.curRowId;
        this.$put(this.urls.purchasereturns + "/" + id + "/submit").then(function () {
          _this11.refresh();
          _this11.$message({
            message: "提交成功",
            type: "success"
    ...
    bfReject: function bfReject() {
      ...
      if (this.newOpt[4].nClick) {
        ...
        var id = this.checkboxId ? this.checkboxId : this.curRowId;
        this.$put(this.urls.purchasereturns + "/" + id + "/reject").then(function () {
          _this12.refresh();
          _this12.$message({
            message: "驳回成功",
            type: "success"
    ...
    bfAudit: function bfAudit() {
      ...
      if (this.newOpt[5].nClick) {
        ...
        var id = this.checkboxId ? this.checkboxId : this.curRowId;
        this.$put(this.urls.purchasereturns + "/" + id + "/audit").then(function () {
          _this13.refresh();
          _this13.$message({
            message: "审核成功",
            type: "success"
    ...
    bfUnAudit: function bfUnAudit() {
      ...
      if (this.newOpt[6].nClick) {
        ...
        var id = this.checkboxId ? this.checkboxId : this.curRowId;
        this.$put(this.urls.purchasereturns + "/" + id + "/unaudit").then(function () {
          _this14.refresh();
          _this14.$message({
            message: "退审成功",
            type: "success"
    ...
    handlePagChg: function handlePagChg(page) {
      ...
      switch (index) {
        case 0:
          ...
          this.newOpt[5].nClick = true;
          this.newOpt[6].nClick = true;
          this.$fetch(this.urls.purchasereturns + "?page=" + page, {
            is_submit: false,
            include: "purchaseReturnDetails.stock.productComponent,purchaseReturnDetails.stock.product,purchaseReturnDetails.supplier,purchaseReturnDetails.purchaseReturnType"
          }).then(function (res) {
            _this15.noSubmitData = res.data;
            _this15.loading = false;
            _this15.purReturnDtl = [];
            var pg = res.meta.pagination;
            _this15.$store.dispatch("currentPage", pg.current_page);
            _this15.$store.commit("PER_PAGE", pg.per_page);
            _this15.$store.commit("PAGE_TOTAL", pg.total);
            if (res.data[0]["purchaseReturnDetails"]["data"].length > 0) {
              res.data[0]["purchaseReturnDetails"]["data"].map(function (item) {
                var productComponent = item["stock"]["productComponent"];
                var product = item["stock"]["product"];
                ...
                _this15.purReturnDtl.push(list);
              });
            }
          }, function (err) {
            if (err.response) {
        ...
        case 2:
          ...
          this.$fetch(this.urls.purchasereturns + "?page=" + page, {
            ...
            _this15.alreadyAuditData = res.data;
            _this15.loading = false;
            _this15.purReturnDtl = [];
            var pg = res.meta.pagination;
            _this15.$store.dispatch("currentPage", pg.current_page);
                      ...
                      return [
                        _c(
                          "el-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.addPurReturnDel(scope.$index)
                              }
                            }
                          },
                          [_vm._v("删除")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0840d6b2", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0840d6b2", Component.options)
  } else {
    hotAPI.reload("data-v-0840d6b2", Component.options)
  }
