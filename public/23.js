  ...
  methods: {
      ...
      switch (index) {
        case 0:
          ...
          this.$fetch(this.urls.stockins, {
            ...
            include: "creator,submitter,auditor,warehouer,warehouse,stockInType,stockInDetails.productComponent.product,stockInDetails.purchaseDetail.purchaseList.purchase,stockInDetails.stockIn"
          }).then(function (res) {
            _this.stockDtlData = [];
            _this.loading = false;
    ...
    proQueryClick: function proQueryClick() {
      ...
      this.$fetch(this.urls.purchaselists, {
        status: true,
        include: "purchase.user,purchaseDetails.productComponent.product,purchaseDetails.purchaseList"
      }).then(function (res) {
    ...
    updateStock: function updateStock() {
      ...
      if (this.newOpt[1].nClick) {
        ...
        var id = this.checkboxId ? this.checkboxId : this.stockRowId;
        this.$fetch(this.urls.stockins + "/" + id, {
          include: "stockInDetails.productComponent.product,stockInDetails.purchaseDetail.purchaseList.purchase.user"
        }).then(function (res) {
    ...
    updateStockConfirm: function updateStockConfirm() {
      ...
      var id = this.checkboxId ? this.checkboxId : this.stockRowId;
      this.$patch(this.urls.stockins + "/" + this.id, submit).then(function () {
    ...
    doCommit: function doCommit() {
      ...
      if (this.newOpt[3].nClick) {
        ...
        if (this.multipleSelection.length == 0) {
          ...
          var id = this.checkboxId ? this.checkboxId : this.stockRowId;
          this.$put(this.urls.stockins + "/" + id + "/submit").then(function () {
            _this12.$message({
              message: "提交成功!",
              type: "success"
            });
    ...
    doPrinter: function doPrinter() {
      ...
      if (!this.newOpt[7].nClick) {
        var id = this.checkboxId ? this.checkboxId : this.stockRowId;
        this.$put(this.urls.stockins + "/" + id + "/print").then(function () {
          _this13.printBtn();
          _this13.$message({
            message: "打印成功!",
            type: "success"
    ...
    doAudit: function doAudit() {
      ...
      if (!this.newOpt[4].nClick) {
        var id = this.checkboxId ? this.checkboxId : this.stockRowId;
        this.$put(this.urls.stockins + "/" + id + "/audit").then(function () {
          _this14.$message({
            message: "审核成功!",
            type: "success"
          });
    ...
    unAudit: function unAudit() {
      ...
      if (!this.newOpt[5].nClick) {
        var id = this.checkboxId ? this.checkboxId : this.stockRowId;
        this.$put(this.urls.stockins + "/" + id + "/unaudit").then(function () {
          _this15.$message({
            message: "退审成功!",
            type: "success"
          });
        ...
        _c(
          ...
          [
            ...
            _c("el-input", {
              ...
              model: {
                value: _vm.searchBox.stock_in_no,
                callback: function($$v) {
                  _vm.$set(_vm.searchBox, "stock_in_no", $$v)
                },
                expression: "searchBox.stock_in_no"
              }
            })
          ],
          1
        ...
        _c(
          ...
          [
            ...
            _c("el-input", {
              ...
              model: {
                value: _vm.searchBox.external_sn,
                callback: function($$v) {
                  _vm.$set(_vm.searchBox, "external_sn", $$v)
                },
                expression: "searchBox.external_sn"
              }
            })
          ],
          1
          ...
          [
            ...
            _c(
              "el-select",
              {
                ...
                model: {
                  value: _vm.searchBox.warehouse_id,
                  callback: function($$v) {
                    _vm.$set(_vm.searchBox, "warehouse_id", $$v)
                  },
                  expression: "searchBox.warehouse_id"
                }
              },
          ...
          [
            ...
            _c(
              "el-select",
              {
                attrs: { clearable: "", placeholder: "请选择" },
                model: {
                  value: _vm.searchBox.stock_in_types_id,
                  callback: function($$v) {
                    _vm.$set(_vm.searchBox, "stock_in_types_id", $$v)
                  },
                  expression: "searchBox.stock_in_types_id"
                }
              },
              _vm._l(_vm.resData["stockintypes"], function(list) {
                return _c(
                  "span",
                  { key: list.id },
                  [
                      ...
                      return [
                        _c(
                          "el-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.addStockDel(scope.$index)
                              }
                            }
                          },
                          [_vm._v("删除")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3c3d3200", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3c3d3200", Component.options)
  } else {
    hotAPI.reload("data-v-3c3d3200", Component.options)
  }
