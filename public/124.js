    ...
    fetchData: function fetchData() {
      ...
      switch (index) {
        ...
        case 1:
          ...
          break;
        case 2:
          this.$fetch(this.urls.customerservicedepts, { 'order_status': '等通知发货', 'include': 'shop,logistic,freightType,distribution,distributionMethod,distributionType,takeDeliveryGoodsWay,customerType,paymentMethod,warehouses,orderItems,businessPersonnel,locker,paymentDetails' }).then(function (res) {
            _this.loading = false;
            _this.orderListData = res.data;
            var pg = res.meta.pagination;
            _this.$store.dispatch('currentPage', pg.current_page);
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("el-tab-pane", { attrs: { label: "订单列表" } }, [
            _c("div", [
                  ...
                  [
                    ...
                    _c("el-input", {
                      ...
                      model: {
                        ...
                        callback: function($$v) {
                          _vm.$set(_vm.searchBox, "cmptn_buyerAddress", $$v)
                        },
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.searchBox.cmptn_Directions, function(item) {
                        return _c("el-option", {
                          key: item.value,
                  ...
                  [
                    ...
                    _c(
                      "el-select",
                      {
                        attrs: { clearable: "", placeholder: "请选择" },
                        model: {
                          value: _vm.cmptn_responsibleParty,
                          callback: function($$v) {
                            _vm.cmptn_responsibleParty = $$v
                          },
                          expression: "cmptn_responsibleParty"
                        }
                      },
                      _vm._l(_vm.searchBox.cmptn_responsiblePartys, function(
                        item
                      ) {
                        return _c("el-option", {
                          key: item.value,
                ...
                _c(
                  ...
                  [
                    ...
                    _c("el-input", {
                      attrs: { clearable: "" },
                      model: {
                        value: _vm.cmptn_responsiblePerson,
                        callback: function($$v) {
                          _vm.cmptn_responsiblePerson = $$v
                        },
                        expression: "cmptn_responsiblePerson"
                      }
                    })
                  ],
                  1
                  ...
                  [
                    ...
                    _c(
                      "el-select",
                      {
                        attrs: { clearable: "", placeholder: "请选择" },
                        model: {
                          value: _vm.cmptn_logisticsCompany,
                          callback: function($$v) {
                            _vm.cmptn_logisticsCompany = $$v
                          },
                          expression: "cmptn_logisticsCompany"
                        }
                      },
                      _vm._l(_vm.searchBox.cmptn_logisticsCompanys, function(
                        item
                      ) {
                        return _c("el-option", {
                          key: item.value,
                  ...
                  [
                    ...
                    _c("el-input", {
                      model: {
                        ...
                        expression: "searchBox.cmptn_logisticsTrackingNumber"
                      }
                    })
                  ],
                  1
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.searchBox.cmptn_orderShops, function(item) {
                        return _c("el-option", {
                          key: item.value,
                          attrs: { label: item.label, value: item.value }
                        })
      ...
      _c(
        ...
        [
          _c(
            "el-tab-pane",
            { attrs: { label: "所有数据", name: "0" } },
            [
              _c(
                "el-table",
                {
                  attrs: {
                    data: _vm.cmptn_orderListData,
                    fit: "",
                    height: "350"
                  }
                },
                [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.cmptn_orderListHead, function(item) {
